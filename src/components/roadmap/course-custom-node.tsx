    ...
    return (
        <div className="group relative w-70">
            <Handle
                ...
                className={cn(
                    'border-background z-20 !-ml-1.5 !h-3 !w-3 cursor-crosshair rounded-full border shadow-sm transition-all hover:scale-150',
                    selected ? 'bg-primary' : 'hover:bg-primary bg-slate-300',
                )}
            />
            <div
                className={cn(
                    'bg-card h-full w-full overflow-hidden rounded-xl border transition-all',
                    selected
            ...
            <Handle
                ...
                className={cn(
                    'border-background z-20 !-mr-1.5 !h-3 !w-3 cursor-crosshair rounded-full border shadow-sm transition-all hover:scale-150',
                    selected ? 'bg-primary' : 'hover:bg-primary bg-slate-300',
                )}
            />{' '}
        </div>
